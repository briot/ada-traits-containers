...
procedure Conts.Algorithms.Sort.Quicksort (Self : in out Cursors.Container) is
   package Ranges is new Ranged_Random_Access_Cursors
     (Cursors, Getters, Swap);
   procedure Shell is new Conts.Algorithms.Sort.Shell
...
end Conts.Algorithms.Sort.Quicksort;
