...
--  This package takes the same formal arguments as GAL.Vectors.Generics
...
package GAL.Vectors.Impl with SPARK_Mode is
   ...
   --  Converts from index into the actual array back to the index type
     with
       ...
       Post   => To_Index'Result = Index_Type'Val
         (Position - GAL.Vectors.Storage.Min_Index
   ...
   package M is new GAL.Functional.Sequences
...
private
   ...
   No_Last : constant Count_Type := GAL.Vectors.Storage.Min_Index - 1;
