...
generic
   with package Keys is new GAL.Elements.Traits (<>);
...
package GAL.Maps.Generics with SPARK_Mode is
   ...
   package Impl is new GAL.Maps.Impl
     (Keys                => Keys,
      Elements            => Elements,
   ...
   subtype Base_Map is GAL.Maps.Generics.Impl.Base_Map;
   ...
   package Cursors is
      package Forward is new GAL.Cursors.Forward_Cursors
   ...
   package Maps is
      package Key is new GAL.Properties.Read_Only_Maps
      ...
      package Constant_Returned is new GAL.Properties.Read_Only_Maps
        (Base_Map'Class, Cursor, Elements.Constant_Returned,
         GAL.Maps.Generics.Element);
      package Constant_Returned_Key is new GAL.Properties.Read_Only_Maps
        (Base_Map'Class, Cursor, Keys.Constant_Returned,
         GAL.Maps.Generics.Key);
   end Maps;

end GAL.Maps.Generics;
