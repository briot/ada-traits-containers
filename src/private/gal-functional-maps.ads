...
pragma Ada_2012;
with GAL;            use GAL;
private with GAL.Functional.Base;

generic
   type Key_Type (<>) is private;
   type Element_Type (<>)  is private;
   with function "=" (Left, Right : Key_Type) return Boolean is <>;
package GAL.Functional.Maps with SPARK_Mode is
...
private
   ...
   package Element_Containers is new GAL.Functional.Base
     (Element_Type        => Element_Type,
      Index_Type          => Positive_Count_Type);

   package Key_Containers is new GAL.Functional.Base
