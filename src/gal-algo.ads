...
package GAL.Algo is
   ...
   generic
      with package Base_Cursors is
        new GAL.Cursors.Random_Access_Cursors (<>);
      with package Base_Getters is new GAL.Properties.Read_Only_Maps
   ...
   package Ranged_Random_Access_Cursors is
      ...
      package Cursors is new GAL.Cursors.Random_Access_Cursors
        (Container_Type     => Rg,
      ...
      package Getters is new GAL.Properties.Read_Only_Maps
        (Map_Type           => Rg,
